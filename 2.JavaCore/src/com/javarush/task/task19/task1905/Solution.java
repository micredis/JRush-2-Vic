...
public class Solution {
    ...
    public static class DataAdapter implements RowItem {
        ...
        public String getCountryCode() {
            ...
            String countryCode = "";
            for (Map.Entry<String, String> country : Solution.countries.entrySet()) {
                if (countryName.equals(country.getValue())) {
                    countryCode = country.getKey();
                    break;
                }
            }
            return countryCode;
        ...
        public String getDialString() {
            ...
            return "callto://+" + sbDigits.toString();
        }
    }

...
public class Solution {
    ...
    public static void main(String[] args) {
        File file = new File("/home/micredis/IdeaProjects/JavaRushVictoria/JavaRushTasks/2.JavaCore/src/com/javarush/task/task20/task2012/temp.ser");
        ...
        try (
            ...
            OutputToConsole otcRecovered = (OutputToConsole) in.readObject();
            otcRecovered.printMessage();
